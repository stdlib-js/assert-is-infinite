...
```javascript
import isInfinite from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-infinite@v0.2.2-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { isObject, isPrimitive } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-infinite@v0.2.2-esm/index.mjs';
```
